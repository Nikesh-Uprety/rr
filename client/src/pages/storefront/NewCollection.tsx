  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="py-16 md:py-24 border-t border-border/40">
        <div className="container mx-auto px-4 md:px-6 max-w-2xl flex flex-col items-center">
          <p className="text-[10px] md:text-xs uppercase tracking-[0.5em] text-muted-foreground font-bold mb-8">
            Follow Us
          </p>
          <div
